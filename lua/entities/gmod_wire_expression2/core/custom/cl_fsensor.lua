...
E2Helper.Descriptions["addOptionHitOnly(xfs:sn)"] = "Adds the option to the "..xfs.." internal hit only list"
E2Helper.Descriptions["remOptionHitOnly(xfs:sn)"] = "Removes the option from the "..xfs.." internal only hit list"
E2Helper.Descriptions["addOptionHitSkip(xfs:ss)"] = "Adds the option to the "..xfs.." internal ignore hit list"
E2Helper.Descriptions["remOptionHitSkip(xfs:ss)"] = "Removes the option from the "..xfs.." internal ignore hit list"
E2Helper.Descriptions["addOptionHitOnly(xfs:ss)"] = "Adds the option to the "..xfs.." internal hit only list"
E2Helper.Descriptions["remOptionHitOnly(xfs:ss)"] = "Removes the option from the "..xfs.." internal only hit list"
