...
E2Helper.Descriptions["getDirectionLocal(xfs:a)"] = "Returns "..xfs.." world "..par[3].." converted to entity local axis"
...
E2Helper.Descriptions["getDirectionWorld(xfs:a)"] = "Returns "..xfs.." local "..par[3].." converted to entity world axis"
